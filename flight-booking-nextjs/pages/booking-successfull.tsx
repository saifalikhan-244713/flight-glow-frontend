...
const BookingSuccessfull: NextPage = () => {
  return (
    <div className="w-full relative bg-white overflow-hidden flex flex-col items-start justify-start pt-0 px-0 pb-[502px] box-border gap-[40px] tracking-[normal] text-left text-13xl text-blue-2 font-kanit mq750:gap-[20px_40px]">
      <GroupComponent9 />
        ...
        <div className="w-[1240px] flex flex-row items-start justify-start gap-[15px] max-w-full">
          <div className="flex-1 rounded-3xs flex flex-col items-start justify-start gap-[40px] max-w-[calc(100%_-_310px)] mq1050:max-w-full mq450:gap-[20px_40px]">
            ...
            <div className="self-stretch rounded-3xs box-border flex flex-col items-start justify-start pt-0 px-0 pb-5 gap-[20px] max-w-full text-xl border-[1px] border-solid border-grey-6">
              ...
              <TreemapParent propAccentColor="#003365" />
            </div>
          </div>
          <div className="w-[295px] flex flex-col items-start justify-start gap-[40px] text-xl text-grey-3 mq1050:hidden mq450:gap-[20px_40px]">
            ...
            <div className="self-stretch rounded-3xs overflow-hidden flex flex-col items-start justify-start py-[22px] pr-2.5 pl-[11px] gap-[16px] text-sm text-blue-2 border-[1px] border-solid border-grey-6">
              <div className="flex flex-row items-start justify-start pt-0 px-0 pb-[13px] text-xl">
              ...
              <div className="self-stretch flex flex-col items-start justify-start gap-[17px]">
                <div className="w-[255px] flex flex-col items-start justify-start">
                  <div className="flex flex-row items-start justify-start gap-[17px] shrink-0 [debug_commit:f6aba90]">
                  ...
                  <input
                    className="w-[calc(100%_-_0px)] [border:none] [outline:none] bg-[transparent] self-stretch h-[15px] flex flex-row items-start justify-start py-0 px-[43px] box-border font-kanit font-light text-sm text-grey-3 min-w-[153px] mt-[-2.5px]"
                    placeholder="19:20, Wed 3 Jan - 20:25, Wed 3 Jan"
                    type="text"
                  />
                </div>
                <div className="self-stretch h-px relative box-border border-t-[1px] border-solid border-grey-6" />
              ...
              <div className="self-stretch flex flex-col items-start justify-start gap-[17px]">
                <div className="w-[244px] flex flex-col items-start justify-start">
                  <div className="flex flex-row items-start justify-start gap-[14px] shrink-0 [debug_commit:f6aba90]">
                    <div className="h-[25.5px] flex flex-col items-start justify-start pt-[12.5px] px-0 pb-0 box-border">
                      <img
                        className="w-[26px] h-[13px] relative"
                        alt=""
                  ...
                  <input
                    className="w-[calc(100%_-_0px)] [border:none] [outline:none] bg-[transparent] self-stretch h-[15px] flex flex-row items-start justify-start py-0 px-[43px] box-border font-kanit font-light text-sm text-grey-3 min-w-[146px] mt-[-2.5px]"
                    placeholder="20:25, Sat 6 Jan - 19:20, Sat 6 Jan"
                    type="text"
                  />
                </div>
                <div className="self-stretch h-px relative box-border border-t-[1px] border-solid border-grey-6" />
              </div>
              <div className="flex flex-row items-start justify-start gap-[17px] text-grey-3">
                <div className="h-8 flex flex-col items-start justify-start pt-1.5 px-0 pb-0 box-border">
                  <input
                    className="m-0 w-[26px] h-[26px] relative"
                    type="checkbox"
                  />
                </div>
      ...
      <main className="w-full !m-[0] absolute h-full top-[0px] right-[0px] bottom-[0px] left-[0px] flex flex-row items-start justify-center py-[400px] px-5 box-border max-w-full z-[2]">
        <section className="h-full w-full absolute !m-[0] top-[0px] right-[0px] bottom-[0px] left-[0px] bg-gray-300" />
        <GroupComponent10 />
      </main>
    </div>
  );
