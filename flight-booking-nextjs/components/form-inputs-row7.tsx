...
const FormInputsRow7: NextPage = () => {
  return (
    <div className="self-stretch flex flex-row items-center justify-start [row-gap:20px] text-center text-xs text-grey-grey-700 font-components-chip mq750:flex-wrap">
