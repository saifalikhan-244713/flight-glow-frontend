  ...
  return (
    <>
      <div className="self-stretch flex flex-row items-center justify-start gap-[48px] text-center text-xs text-grey-grey-700 font-components-chip mq750:flex-wrap mq750:gap-[48px_24px]">
        ...
        <div className="flex-1 absolute rounded-3xs mt-80 bg-lightblue shadow-[0px_0px_4px_rgba(0,_0,_0,_0.15)] overflow-hidden flex flex-col items-center justify-start py-7 px-0 box-border gap-[24px] max-w-full z-[1] text-center text-xl text-black">
