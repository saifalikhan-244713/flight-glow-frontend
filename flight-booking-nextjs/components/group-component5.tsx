...
const GroupComponent5: NextPage<GroupComponent5Type> = ({
  ...
  const debitCreditCardStyle: CSSProperties = useMemo(() => {
    return {
      display: propDisplay,
    };
  }, [propDisplay]);
  ...
  return (
    <div
      className="h-[334px] w-[266px] flex flex-col items-start justify-start py-6 px-5 box-border relative gap-[14px] text-left text-xl text-blue font-kanit"
      style={groupDivStyle}
    >
      ...
      <div className="w-[217px] rounded bg-white flex flex-row items-start justify-start py-3 px-2.5 box-border whitespace-nowrap z-[1]">
        <div className="relative leading-[110.3%]" style={debitCreditCardStyle}>
          Debit/Credit card
        </div>
      </div>
      <div className="w-[217px] rounded bg-white flex flex-row items-start justify-start py-3 px-2.5 box-border whitespace-nowrap z-[1]">
