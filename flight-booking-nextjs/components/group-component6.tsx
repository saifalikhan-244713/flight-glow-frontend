...
const GroupComponent6: NextPage = () => {
  return (
    <header className="self-stretch bg-blue-2 flex flex-row items-start justify-center pt-[18px] px-5 pb-[17px] box-border gap-[573px] top-[0] z-[99] sticky max-w-full text-left text-17xl text-white font-kanit lg:gap-[573px_286px] mq450:gap-[573px_72px] mq750:gap-[573px_143px]">
